...
//////////////////////////////////////////////////////////////////////////////////////////////////////////          
        ...
        { 
          ...
          $prim_pago = 0;
            ...
            $total_plan = 0;
              ...
              if ($equipo == "TVX125") {
                    ...
                    $descripcion_paquete = $descripcion_paquete ."<p> Equipo incluido:  TVX588D SIM DUAL Rugged unlocked Android Smart Phone </p>";
                    ...
                    $descripcion_paquete = $descripcion_paquete ."<p> Equipo incluido:  TVX887 SIM DUAL Rugged unlocked Android Smart Phone </p>";
          ...
          <br>
          <br>
          <table><tr><td style="float: left;  margin-top: -15px; border: 0px;"><p> DETALLE PAGO INICIAL - ÚNICA VEZ</p></td></tr></table>
          ...
          <tr>
            <td>ACTIVACIÓN / CONFIGURACIÓN DE USUARIOS  Y GRUPOS</td>
            <td align="center">'.$cantidad.'</td>
            <td align="right">$ '.number_format($activ, 2, '.', ',').'</td>
            <td align="right">$ '.number_format($round_act_tot, 2, '.', ',').'</td>
          </tr>
